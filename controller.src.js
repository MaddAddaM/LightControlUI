(function() {
	...
	var standardTracks = [
			new trackModel("Color Test: White", 4),
			new trackModel("Color Test: Aquamarine", 4),
			new trackModel("Color Test: Purple", 4),
			new trackModel("Color Test: Blue", 4),
			new trackModel("Color Test: Yellow", 4),
			new trackModel("Color Test: Green", 4),
			new trackModel("Color Test: Red", 4),
			new trackModel("Color Test: Black", 4),
			new trackModel("Trippy: Visuals and sometimes intense", 3114),
			new trackModel("Trippy: Lots of color", 68),
			new trackModel("Trippy: Bright colors and patterns", 92),
			new trackModel("Trippy: Big blue, yellow, and purple shapes", 540),
			new trackModel("Trippy: Rainbow colored noise mix", 474),
			new trackModel("Trippy: Bright lines of color", 22),
			new trackModel("Trippy: Rainbow swoosh", 5),
			new trackModel("Trippy: Mandelbrot fractal zoom", 25),
			new trackModel("Trippy: Big bright blocks of moving color", 304),
			new trackModel("Trippy: Bright colors, random movement, black or white backgrounds", 2905),
			new trackModel("Trippy: Bright colors with lots of zoom/rotate motions", 3246),
			new trackModel("Trippy: Bright colors, moving light/dark effects, random movement", 3144),
			new trackModel("Trippy: Bright flowing colors, random movement", 2904),
			new trackModel("Flow Art: Gloves, close up", 249),
			new trackModel("Flow Art: Gloves, less close up", 259),
			new trackModel("Flow Art: Poi", 247),
			new trackModel("Flow Art: Fire spinner in a tube", 80),
			new trackModel("Flow Art: Lightsaber", 40),
			new trackModel("Flow Art: Lightsaber", 40),
			new trackModel("Flow Art: Poi", 52),
			new trackModel("Flow Art: Lightsaber with silhouettes", 222),
			new trackModel("Flow Art: Lightsabers", 26),
			new trackModel("Chill: Chill circular motion colors", 7210),
			new trackModel("Chill: Ropes of moving color", 155),
			new trackModel("Chill: Rainbow colors on white background", 269),
			new trackModel("Chill: Rainbow colors on black background", 269),
			new trackModel("Chill: Rotating rainbow colors on a white background", 144),
			new trackModel("Chill: Rotating rainbow colors on a black background", 144),
			new trackModel("Chill: Rainbow aurora effect", 239),
			new trackModel("Chill: Saturated colors expanding out from center", 240),
			new trackModel("Chill: Muted colors moving around center point", 3610),
			new trackModel("Chill: Muted colors moving around center point", 3590),
			new trackModel("Chill: Muted colors moving around center point", 1788),
			new trackModel("Chill: Muted colors moving around center point", 3590),
